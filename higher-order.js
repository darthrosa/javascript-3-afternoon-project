...
// let postTaxPrices = price.map(function(num){
//   return num * 1.07
// })
...
let bobsTotal = purchases.filter(purchase => purchase.owner === 'Bob').map(purchase => purchase.price).reduce((aPrice, bPrice) => aPrice + bPrice)
